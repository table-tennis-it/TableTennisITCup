...
5.4. Если личная встреча не имеет турнирного значения (например на стадии плей-офф где результат 4-2 4-3 роли не играет), она может быть доиграна в случае если: судья или огранизаторы не имеют возражений и оба игрока желают ее продолжить.
...
7.1. Игры группового этапа проходят в субботу 7 июля. Время игр будет опубликовано на сайте [http://www.tabletennisit.com/tournaments/kiev-open-2018](http://www.tabletennisit.com/tournaments/kiev-open-2018).

7.2. Игры третьего финала (для команд занявших 5 место в группе) проходят в субботу после групповой стадии в 18-30.

7.3. Игры первого финала (для команд занявших 1-2 место в группе) начинаются в воскресенье 8 июля в 9-00

7.4. Игры второго финала (для команд занявших 3-4 место в группе) начинаются в воскресенье в 16-00
...
14.3. При использовании игровой хватки «перо», в случае, когда одна из сторон ракетки накладки не имеет, эта сторона во время игры использоваться не должна.

14.4. Если игрок не играет "пером" обе стороны основания должны быть с накладками.

14.5. В начале встречи игрок должен показать свою ракетку сопернику по его просьбе. После начала встречи игрок не может просить соперника показать ему свою ракетку.

14.6. В случае если основание или накладки повредились во время игры, игрок может заменить инвентарь и после небольшой разминки продолжить игру.
