# Table Tennis IT Cup Kiev Open 2019
...
5.2. Встречи группового этапа проводятся из трех сетов (до 2 выигранных сетов). Встречи финалов играются из пяти сетов (до 3 выигранных).
...
5.4. Если личная встреча не имеет турнирного значения (например на стадии плей-офф где результат 4-2 4-3 роли не играет), она может быть доиграна в случае если: судья или организаторы не имеют возражений и оба игрока желают ее продолжить. В этом случае доигранная встреча пойдет в статистику игрокам, и повлияет на итоговый командный счет
...
6.1. После того, как все команды подтвердили свое участие взносом. На сайте появится упорядоченный список команд согласно рейтингу.

При посеве учитывается личный IT рейтинг. В случае если он отсутствует, то используется ФНТУ или TTW<sup>[*](#personal-ratings)</sup>.

Для определения командного рейтинга строится [симуляция](http://www.tabletennisit.com/tournaments/kiev-open-2019/simulation), если бы каждая команда играла с каждой. Виртуальная командная встреча состоит из 9 личных игр (3 сильнейших игрока по рейтингу встречаются с 3 сильнейшими игроками по рейтингу другой команды) + парная встреча 2 сильнейших игроков. Победитель командной встречи получает 1 очко. В случае ничьи каждому участнику начисляется 0.5. Место занятое в симуляции и есть рейтинг игрока. Если команды в симуляции набрали одинаковое количество очков, то 1) берется во внимание личная встреча, 2) отношения выигранных к проигранными командным матчам, 3) отношение выигранных к проигранным личным встречам 4) время оплаты взноса

<a name="personal-ratings">*</a> ФНТУ и TTW рейтинг сводится к IT, используя отношения рейтингов Плохого Тимофея (#1 IT Рейтинга) затем выбирается максимальный из получившихся. В качестве ФНТУ рейтинга берется текущий Р (без штрафов), а не РШ.

6.2. Командны, зарегистрированные после формирования групп, добавляются змейкой после оплаты стартового взноса.

6.3. После того как сформированы группы, команды может зарегистрировать игрока только в случае, если его личные рейтинги не повлияют на общий командный.

6.4. В случае, если заявленный игрок, рейтинг которого вошел в общий командный не принимал участие в турнире, то команда получает предупреждение. В случае повторного предупреждения на следующий турнир с команды будет вычтена разность новых рейтингов этого игрока и игрока, который его заменил.

6.5. Группы формируются по принципу "змейки"

1.  1 сеяная, 16, 17, 32, 33
1.  2, 15, 18, 31, 34
1.  3, 14, 19, 30, 35
1.  4, 13, 20, 29, 36
1.  5, 12, 21, 28, 37
...
6.6. Если команда с меньшим рейтингом заняла выше место, то она дальше сеется, по рейтингу команды место, которой она заняла.

6.7. Сетка Senior Final.
...
7.1. Игры группового этапа проходят в клубе [Гурман](http://www.tabletennisit.com/places/gurman) в субботу 21 сентября. Начало каждой группы можно будет посмотреть на сайте рядом с ее названием [http://www.tabletennisit.com/tournaments/kiev-open-2019](http://www.tabletennisit.com/tournaments/kiev-open-2019).

7.2. Игры первого финала "Senior Final" (для команд, занявших 1-2 место в группе) проводятся в клубе [Гурман](http://www.tabletennisit.com/places/gurman) в воскресенье 22 сентября в 9-00, разминка с 8-00. 16 команд первого финала будут играть по олимпийской системе с определением всех мест

7.3. Игры третьего финала "Junior Final" (для команд, занявших 5-6 место в группе), проводятся в клубе [Гурман](http://www.tabletennisit.com/places/gurman) в воскресенье 22 сентября в 17-00. Формат третьего финала зависит от количество команд

7.4. Игры второго финала "Middle Final" (для команд, занявших 3-4 место в группе) проводятся в клубе [Воля](http://www.tabletennisit.com/places/volya) в воскресенье в 10-00, разминка с 9-00. 16 команд второго финала будут играть по олимпийской системе с определением всех мест
...
7.6. Если после группового этапа команда, попавшая в первый финал, снимается с соревнований и предупреждает об этом организаторов в первый день. То ее место займет команда попавшая в третий финала, которая играла в той же группе.
...
Суббота Клуб [Гурман](http://www.tabletennisit.com/places/gurman), адрес ул. Нижнеюрковская, 31, Киев
Групповой этап. Время начало каждой игры в каждой группе можно увидеть на сайте http://www.tabletennisit.com/tournaments/kiev-open-2019

Воскресенье Клуб Гурман
9-00 начало игр 1 Финала (для команд, занявших 1,2 место в группах). Разминка с 8-00

Воскресенье Зал Гурман
17-00 3 Финал (для команд, занявших 5,6 место в группах)

Воскресенье Зал [Воля](http://www.tabletennisit.com/places/volya), бул. Перова 36 ТРК Квадрат, Киев
10-00 начало игр 2 Финала (для команд, занявших 3,4 место в группах). Разминка с 9-00
...
Кльоз Сергей:
[sergii.kloz@gmail.com](mailto:sergii.kloz@gmail.com)
skype: sergii_kloz
phone: 050 073 35 30
