...
6.1. После того, как все команда подтвердили свое участие взносом. На сайте появится упорядоченный список команд. Команды сортируются по [рейтингу](https://github.com/table-tennis-it/TableTennisITCup/blob/kiev-open-2018/rating.tsv). Команды не входящие в рейтинг будут упорядочены по времени сдачи взноса.
...
7.1. Игры группового этапа проходят в субботу 7 июля. Начало каждой группы можно посмотреть на сайте рядом с ее названием [http://www.tabletennisit.com/tournaments/kiev-open-2018](http://www.tabletennisit.com/tournaments/kiev-open-2018).
...
7.3. Игры первого финала Senior Final (для команд занявших 1-2 место в группе) начинаются в воскресенье 8 июля в 9-00. 16 команд первого финала будут играть по олимпийской системе с определеним всех мест
