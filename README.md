...
При посеве учитывается личный IT рейтинг. В случае если он отсутствует, то используется ФНТУ или TTW[^ratings].
...
[^ratings]: ФНТУ и TTW рейтинг сводится к IT, используя отношения рейтингов Плохого Тимофея (#1 IT Рейтинга) затем выбирается максимальный из получившихся. В качестве ФНТУ рейтинга берется текущий Р (без штрафов), а не РШ.
