# Table Tennis IT Cup Kharkiv Open 2018
...
6.1. (Возможны изменения) После того, как все команды подтвердили свое участие взносом. На сайте появится упорядоченный список команд. Команды сортируются по [рейтингу](https://github.com/table-tennis-it/TableTennisITCup/blob/kharkiv-open-2018/rating.tsv). Новые команды сортируются по суммарному личному рейтингу 3 сильнейших участников. Затем идут команды без личных рейтингов, упорядоченные по времени сдачи взноса.

6.2. Группы формируются по принципу "змейки". В случае если будет 8 групп, то группы будут выглядеть следующим образом:
...
6.3. Если команда с меньшим рейтингом заняла выше место, то она дальше сеется, по рейтингу команды место, которой она заняла.

6.4. В 1/8 не могут встречаться команды, занявшие одинаковые места в группах.

6.5. В 1/4 должны встретиться:
...
7.1. Игры группового этапа проходят в субботу 8 декабря. Начало каждой группы можно посмотреть на сайте рядом с ее названием [http://www.tabletennisit.com/tournaments/kharkiv-open-2018](http://www.tabletennisit.com/tournaments/kharkiv-open-2018).

7.2. Игры третьего финала Junior Final (для команд занявших 5-6 место в группе) проходят в субботу после групповой стадии в 18-30. Формат 3 финала определяется в зависимости от количества пришедших команд. Если прийдет более 8 команд, то команды будут разбиты на 2 группы. Если 8-6 участников командны будут играть по олимпийской системе с определением всех мест. Если 5 и меньше, то команды будут играть по кругу в группе

7.3. Игры первого финала Senior Final (для команд занявших 1-2 место в группе) начинаются в воскресенье 9 декабря в 9-00. 16 команд первого финала будут играть по олимпийской системе с определеним всех мест
...
Теннисный Клуб Метеорит ул. Академика Павлова, 82 к.2, Харьков

[http://www.tabletennisit.com/places/meteorit](http://www.tabletennisit.com/places/meteorit)


## 11. Мячи турнира

Пластик 40+ (Марка мячей будет известна в ближайшие дни)
...
Сергей Воронов: [sergiyv@gmail.com](mailto:sergiyv@gmail.com)
skype: serg_voronov
phone: (095) 937-63-49

Александр Кривчиков: [alex.krivchikov93@gmail.com](mailto:alex.krivchikov93@gmail.com)
skype: pavel1971338
phone: 0502977287, 0675982881
