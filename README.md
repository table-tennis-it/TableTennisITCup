# Table Tennis IT Cup Kharkiv Open 2019
...
Встречи группового этапа и второго финала проходят до 3 побед по схеме:
...
5.2. Все игры проводятся из пяти сетов (до 3 выигранных сетов).
...
7.1. В субботу 7 декабря проходит Групповой этап. Начало каждой группы можно будет посмотреть на сайте рядом с ее названием [http://www.tabletennisit.com/tournaments/kharkiv-open-2019](http://www.tabletennisit.com/tournaments/kharkiv-open-2019).

7.2. Игры первого финала "Senior Final" (для команд, занявших 1-2 место в группе) проходят в воскресенье 8 декабря в 9-00, разминка с 8-00. 16 команд первого финала будут играть по олимпийской системе с определением всех мест
...
7.4. Если после группового этапа команда снимается с соревнований и предупреждает об этом организаторов в первый день. То места в группе расставляются без учета снявшейся команды
...
Клуб [Метеорит](http://www.tabletennisit.com/places/meteorit), ул. Академика Павлова, 82 к.2, Харьков.
...
Сергей Воронов:
[sergiyv@gmail.com](mailto:sergiyv@gmail.com)
phone: (095) 937-63-49
